...
public class MockMVCUtils {
	...
	public <T> String controllerResponseTesterPayloadUtil(MockMvc mockMvc, T payLoad, MockHttpServletRequestBuilder requestBuilder,
		...
		if (!payLoad.getClass().equals(String.class)) {
			...
			String responseBody = mockMvc
					.perform(patch("http://localhost:8080/api/persona/1").content((String) payLoad).contentType(MediaType.APPLICATION_JSON))
