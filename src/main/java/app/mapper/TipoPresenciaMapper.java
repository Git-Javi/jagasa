...
public interface TipoPresenciaMapper {
	...
	TipoPresencia mergeTipoPresenciaIdAndTipoPresenciaDtoToTipoPresencia (@NotNull @Positive Long tipoPresenciaId, @Valid @NotNull TipoPresenciaDto tipoPresenciaDTo);	
}
